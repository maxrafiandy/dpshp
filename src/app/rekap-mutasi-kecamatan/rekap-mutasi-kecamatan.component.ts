...
@Component({
  selector: 'app-rekap-mutasi-kecamatan',
  templateUrl: './rekap-mutasi-kecamatan.component.html',
  styleUrls: ['./rekap-mutasi-kecamatan.component.css']
})
export class RekapMutasiKecamatanComponent implements OnInit {
